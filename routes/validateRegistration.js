...
function validateRegisteration(userName, email, password, confirm_password) {
...
function testValidator(userName, email, password, confirm_password) {
    return __awaiter(this, void 0, void 0, function () {
        var response, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, validateRegisteration(userName, email, password, confirm_password)];
                case 1:
                    response = _a.sent();
                    if (!response) {
